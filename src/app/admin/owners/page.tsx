...
export default function OwnersPage() {
  ...
  const handleCreate = async (e: React.FormEvent) => {
    ...
    if (!res.ok) {
      ...
      setFormError(data.error || 'Não foi possível cadastrar o proprietário.');
      return;
    }
        ...
        {formOpen && (
          ...
          >
            ...
            <div className="md:col-span-2">
              ...
              >
                {submitting ? 'Salvando...' : 'Cadastrar Proprietário'}
              </button>
            </div>
          </form>
        )}
              ...
              <tbody>
                {owners.map((owner) => (
                  <tr key={owner.id} className="border-t border-gray-100">
                    ...
                    <td className="px-6 py-4 text-gray-600">{owner.pix_key || '—'}</td>
